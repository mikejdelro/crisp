                ...
                ! function (a, e) {
                    ...
                    if (t) {
                        ...
                        if (r instanceof RegExp && (r = t[n] = {
                            ...
                            for (var o = 0, s = r.length; o < s; o++) r[o] instanceof RegExp && (r[o] = {
                                pattern: r[o]
                            }), e(r[o]);
                        else e(r)
                    }
        ...
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("show-language", function (a) {
                ...
                if (e && /pre/i.test(e.nodeName)) {
                    var s, t = e.getAttribute("data-language") || r[a.language] || ((s = a.language) ? (s.substring(0, 1).toUpperCase() + s.substring(1)).replace(/s(?=cript)/, "S") : s);
                    if (t) {
